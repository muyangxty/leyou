...
public class SearchService {
    ...
    public SearchResult search(SearchRequest request) {
        ...
        //添加结果集过滤，通过设置返回的结果字段，只需要id,skusubTitle
        queryBuilder.withSourceFilter(new FetchSourceFilter(new String[]{"id", "skus", "subTitle"}, null));

        //添加分类和品牌的聚合
        String caetegoryAggName = "categories";
        String brandAggName = "bradns";
        queryBuilder.addAggregation(AggregationBuilders.terms(caetegoryAggName).field("cid3"));
        ...
        //获取聚合结果集并解析
        List<Map<String, Object>> categories = getCategoryAggResult(goodsPage.getAggregation(caetegoryAggName));
